@extends('layouts.app', ['page' => __('New Course Name '), 'pageSlug' => 'users', 'section' => 'users'])
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('New Course Name') }}</h3>
                            </div>
                    ...
                    <div class="card-body">
                        <form method="post" action="/course_names" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="pl-lg-4">

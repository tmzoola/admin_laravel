...
<main class="main" id="top">
    ...
    <section class="pb-6 pt-10 ">
        ...
        <div class="container ">
            <div class="row flex-center">
                <div class="col-lg-6 col-md-5 order-md-1"><img class="img-fluid" src="{{asset('new_design/assets/img/illustrations/1-a.png')}}" alt="" /></div>
                <div class="col-md-7 col-lg-6 mt-5 text-center text-md-start">
                    <h1 class="fw-medium"> <span class="fw-bold brand-color">Biz </span>bilan o'rganish oson</h1>
                    <p class="mt-3 mb-4"><span class="fw-semi-bold brand-color ">“</span>You can’t connect the dots looking forward;  you can only connect them looking backward.<br> So you have to trust that the dots will somehow connect in your future. <span class="fw-semi-bold brand-color ">“</span><br> <span class="fw-medium">STIVE JOBS</span>  </p>
                    <a class="btn btn-lg btn-brand hover-top btn-glow" href="#">Boshlash </a>
                </div>
            </div>
        </div>
        <!-- end of .container-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <div class="border-end d-flex justify-content-md-center">
                                <div class="mx-2 mx-md-0 me-md-5">
                                    <div class="badge badge-circle bg-soft-green">
                                        <svg class="bi bi-geo-alt-fill" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#20c997" viewBox="0 0 16 16">
                        ...
                        <div class="col-4">
                            <div class="d-flex justify-content-md-center">
                                <div class="mx-2 mx-md-0 me-md-5">
                                    <div class="badge badge-circle bg-soft-green">
                                        <svg class="bi bi-hdd-stack-fill" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#20c997" viewBox="0 0 16 16">
                ...
                <div class="col-md-4 pt-4 px-md-2 px-lg-3">
                    <div class="card h-100">
                        <div class="card-body d-flex flex-column justify-content-around mx-auto">
                            <div class="text-center pt-5"><img class="img-fluid" src="{{asset('new_design/assets/img/icons/pricing.png')}}" alt="" />
                                <h5 class="my-4">Free Plan</h5>
                            </div>
                            <ul class="list-unstyled">
                                <li class="mb-3"><span class="me-2">
                        <svg class="bi bi-check" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#20c997" viewBox="0 0 16 16">
    ...
    <section class="py-5 bg-100">
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-6 col-sm-4 col-md-2 mb-2 mb-md-0"><img class="img-fluid" src="{{asset('new_design/assets/img/gallery/netflix.png')}}" alt="" height="50" /></div>
                <div class="col-6 col-sm-4 col-md-2 mb-2 mb-md-0"><img class="img-fluid" src="{{asset('new_design/assets/img/gallery/reddit.png')}}" alt="" height="50" /></div>
                <div class="col-6 col-sm-4 col-md-2 mb-2 mb-md-0"><img class="img-fluid" src="{{asset('new_design/assets/img/gallery/amazon.png')}}" alt="" height="50" /></div>
                <div class="col-6 col-sm-4 col-md-2 mb-2 mb-sm-0"><img class="img-fluid" src="{{asset('new_design/assets/img/gallery/discord.png')}}" alt="" height="50" /></div>
                        ...
                        <div class="row h-100">
                                ...
                                <div class="card h-100">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="d-flex align-items-center"><img class="img-fluid" src="{{asset('new_design/assets/img/gallery/user-1.png')}}" alt="" />
                            ...
                            <div class="col-md-4 mb-3 mb-md-0">
                                <div class="card h-100">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="d-flex align-items-center"><img class="img-fluid" src="{{asset('new_design/assets/img/gallery/user-2.png')}}" alt="" />
                                                <div class="flex-1 ms-3">
                            ...
                            <div class="col-md-4 mb-3 mb-md-0">
                                <div class="card h-100">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="d-flex align-items-center"><img class="img-fluid" src="{{asset('new_design/assets/img/gallery/user-3.png')}}" alt="" />
                                                <div class="flex-1 ms-3">
                                                    <h6 class="mb-0 fs--1 text-1000 fw-medium">Viezh Robert</h6>
                ...
                <div class="col-12 col-lg-4 mb-3"><a href="#"><span class="d-inline-block text-1000 fs-3 brand-color ms-2 fw-medium lh-base">INCOURSE</span></a>
                    ...
                    <ul class="list-unstyled list-inline">
                        ...
                        <li class="list-inline-item"><a href="#!">
                                <svg class="bi bi-twitter" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#20c997" viewBox="0 0 16 16">
                                    <path d="M5.026 15c6.038 0 9.341-5.003 9.341-9.334 0-.14 0-.282-.006-.422A6.685 6.685 0 0 0 16 3.542a6.658 6.658 0 0 1-1.889.518 3.301 3.301 0 0 0 1.447-1.817 6.533 6.533 0 0 1-2.087.793A3.286 3.286 0 0 0 7.875 6.03a9.325 9.325 0 0 1-6.767-3.429 3.289 3.289 0 0 0 1.018 4.382A3.323 3.323 0 0 1 .64 6.575v.045a3.288 3.288 0 0 0 2.632 3.218 3.203 3.203 0 0 1-.865.115 3.23 3.23 0 0 1-.614-.057 3.283 3.283 0 0 0 3.067 2.277A6.588 6.588 0 0 1 .78 13.58a6.32 6.32 0 0 1-.78-.045A9.344 9.344 0 0 0 5.026 15z"></path>
                                </svg></a></li>
                        <li class="list-inline-item"><a href="#!">
                                <svg class="bi bi-instagram" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#20c997" viewBox="0 0 16 16">
